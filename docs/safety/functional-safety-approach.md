...
- 1.1.9: Protection against corruption — **NEW in 2023/1230** [S,85]: control systems must be protected against intentional or unintentional corruption that could lead to a hazardous situation. This is the Machinery Regulation's cybersecurity hook — connects directly to OT security (docs/security/ot-security-architecture.md) and CRA.
