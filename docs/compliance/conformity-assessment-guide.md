...
## Confidence notes
 EU product regulation for CPS is multi-layered and in transition. Machinery Regulation 2023/1230 general application starts on 2027-01-20 [F,90] with staged earlier applicability for selected articles [F,85]. CRA (EU 2024/2847) applies fully from 2027-12-11, with Chapter IV from 2026-06-11 and Article 14 from 2026-09-11 [F,90]. RED Delegated Regulation (EU) 2022/30 applies from 2025-08-01 [F,90] and may later be repealed to align with CRA [S,80]. Harmonised standards (hEN) under each directive are being developed or transitioned — mark specific hEN references Unknown unless verified on the OJ/EUR-Lex. Notified body availability for new regulations is Unknown. CE marking interactions between multiple directives require careful analysis — each directive's conformity assessment is independent but the CE marking is cumulative.
...
| **Radio Equipment Directive (RED) 2014/53/EU** | Product contains radio equipment (Wi-Fi, BLE, cellular, etc.) | Essential requirements Art. 3, including cybersecurity delegated act (Delegated Regulation (EU) 2022/30, applies from 2025-08-01) [F,90] |
...
- Art. 3.3(d), (e), (f): Cybersecurity, personal data protection, fraud prevention — activated by Delegated Regulation (EU) 2022/30 (applies from 2025-08-01) [F,90]

RED cybersecurity delegated act status: Delegated Regulation (EU) 2022/30 applies from 2025-08-01 [F,90]. The Commission has proposed repeal from 2027-12-11 to align RED cybersecurity obligations with the CRA for overlapping products [S,80]. Treat the current state as: applicable now, transition path pending final adoption of the repeal.
...
- Machinery Regulation 2023/1230 general application: 2027-01-20 [F,90]; certain articles already apply earlier [F,85]
- CRA application: Chapter IV from 2026-06-11, Article 14 from 2026-09-11, full application from 2027-12-11 [F,90]
- RED cybersecurity delegated act (2022/30): applies from 2025-08-01 [F,90]; monitor the proposed repeal effective 2027-12-11 [S,80]
- Start with longest-lead items: notified body engagement, SIL certification, CRA SBOM infrastructure

**L) Cross-references**

- **docs/safety/functional-safety-approach.md** (`docs/` in this repo): SIL/PL determination and safety evidence feed Machinery Regulation EHSR compliance.
- **docs/security/ot-security-architecture.md** (`docs/` in this repo): IEC 62443 controls feed CRA Annex I evidence and Machinery Regulation EHSR 1.1.9.
