...
*All requirement mappings [S,80]. Verify against current official texts. Machinery Regulation 2023/1230 general application starts on 2027-01-20 with staged earlier applicability for selected articles [F,85]. CRA applies fully from 2027-12-11, with Chapter IV from 2026-06-11 and Article 14 from 2026-09-11 [F,90]. Harmonised standards remain under development — mark specific hEN references Unknown unless verified.*
