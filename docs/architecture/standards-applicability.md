...
|-----------|-----------|----------------|-----------------|
| **Machinery Regulation 2023/1230** | Product is a machine, partly completed machine, safety component, lifting accessory, etc. [F,90] | EHSR (Annex III), risk assessment, technical documentation, DoC, CE marking | Annex V (self) / VII (NB) / VIII (NB-QA) |
...
| **RED 2014/53/EU** | Product contains radio equipment (Wi-Fi, BLE, cellular, etc.) | Art. 3 essential requirements including cybersecurity delegated act [F,90] | Internal / EU-type exam |
...
**Application dates (verified on 2026-03-08 against EUR-Lex):**
- Machinery Regulation: general application from 2027-01-20 [F,90]; certain articles apply earlier from 2023-07-19, 2024-01-20, 2024-07-20, and 2026-10-20 [F,85]
- CRA: general application from 2027-12-11 [F,90]; Article 14 applies from 2026-09-11 and Chapter IV (Articles 35–51) from 2026-06-11 [F,90]
- RED cybersecurity delegated act (Delegated Regulation (EU) 2022/30): applies from 2025-08-01 [F,90]; repeal from 2027-12-11 has been proposed to align with CRA [S,80]
...
*All applicability claims [I,80] unless noted. Specific standard edition/clause references [S,85]. EU regulation application dates above were verified on 2026-03-08 against EUR-Lex and should be re-checked before release. Austrian NISG 2026 effective 2026-10-01 [S,85].*
